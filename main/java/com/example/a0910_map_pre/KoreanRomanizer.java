...
public class KoreanRomanizer {
	 ...
	 */
	public static String romanize(String string, KoreanCharacter.Type district, KoreanCharacter.Type substantives, KoreanCharacter.ConsonantAssimilation regressive) {
